        ...
        <div className='flex items-center gap-x-0.5'>
            ...
            {isEditing ? (
                <input 
                    ...
                    className='h-7 w-10 shrink-0 justify-center text-center border border-neutral-400 rounded-sm bg-transparent focus:outline-none focus:ring-0' 
                />
            ) : (
                <button
                    onClick={() => {
                    ...
                    className='h-7 w-10 shrink-0 justify-center text-center border border-neutral-400 rounded-sm hover:bg-neutral-200/80'
                >
                    {currentFontSize}
                </button>
            )}
    ...
    return(
        <>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Insert Image Title</DialogTitle>
                    </DialogHeader>
                    <Input 
